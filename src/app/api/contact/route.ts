...
export async function POST(request: Request) {
  try {
    ...
    const confirmHtml = emailShell(
      ...
      <p style="margin:0 0 16px;line-height:1.6;">Thank you for contacting <strong>${escapeHtml(SITE_NAME)}</strong>. We have successfully received your enquiry. A member of our financial advisory team will review your message and reply within <strong>two working days</strong>.</p>
