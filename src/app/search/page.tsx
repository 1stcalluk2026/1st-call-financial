...
export const metadata = {
  title: "Search",
  description: "Search 1st Call UK Financial Services for accounting, tax, and payroll advice.",
  robots: {
    index: false,
    follow: true,
  },
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-gray-700">
            Find accounting services, tax advice, and answers across our website.
          </p>
        </div>
        ...
        <form action="/search" method="get" className="flex gap-3">
          <input
            ...
            name="q"
            defaultValue={query}
            placeholder="Search payroll, VAT, MTD, Xero, contact..."
        ...
        {query ? (
          ...
          <p className="text-center text-gray-600">
            Enter a keyword to search our accounting services and FAQs.
          </p>
        )}
      </div>
    </main>
